...
@Component({
  selector: 'app-tempratureconvert',
  templateUrl: './tempratureconvert.component.html',
  styleUrls: ['./tempratureconvert.component.css']
})
export class TempratureconvertComponent implements OnInit {
